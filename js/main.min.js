...
//! SURF SLIDER
$(".surf-slider").slick({slidesToShow:4,slidesToScroll:1,prevArrow:'<img class="slider-arrows slider-arrows__left" src="images/global/arrow-left.svg" alt=""></img>',nextArrow:'<img class="slider-arrows slider-arrows__right" src="images/global/arrow-right.svg" alt=""></img>',asNavFor:".slider-map",focusOnSelect:!0,speed:600,responsive:[{breakpoint:930,settings:{slidesToShow:3,centerMode:!1}},{breakpoint:750,settings:{slidesToShow:2}},{breakpoint:600,settings:{slidesToShow:1,slidesToScroll:1}}]}),
//!  MAP SLIDER 
$(".slider-map").slick({slidesToShow:8,slidesToScroll:1,arrows:!1,asNavFor:".surf-slider",focusOnSelect:!0,responsive:[{breakpoint:930,settings:"unslick",settings:{slidesToShow:3}},{breakpoint:750,settings:{slidesToShow:2}},{breakpoint:600,settings:{slidesToShow:1}}]}),
